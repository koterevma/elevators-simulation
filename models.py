"""
TODO: 
    Lifts should have height variable that represents how far they are above the ground. 
    It should be the main var and "floor" var will be calculated with it. 
    Also make a settings.py file where global vars such as "ONE_FLOOR_HEIGHT" will be declared. 
"""
...
class Elevator():
    ...
    def __init__(self, max_capacity: int, max_floor: int, min_floor: Optional[int] = None, speed: Optional[float] = None):
